...
`;
  ...
  render() {
    return (
      ...
      <Body>
          <TextBlock>
            <SideBar src='https://media.giphy.com/media/Vg5wQRnOoxm2lvWYrd/giphy.gif'/>
            <About>
              ...
              <img src={tel} width='50%' style={{padding: '20px'}}/>
              <img src={tel2} width='50%' style={{padding: '20px'}}/>
              </div>
            </About>
          </TextBlock>
      </Body>
      ...
      <Body style={{backgroundColor: '#fff', color: '#333333'}}>
          <TextBlock>
            <About>
              ...
              Backend: python
              <img src={quantum} width='50%' style={{paddingTop: '2%', borderTop: '2px', borderLeft: '2px', borderRight: '2px'}} />
              <img src={quantum2} width='50%' />
            </About>
